  ...
  const handleFileUpload = async (file: File) => {
    ...
    try {
      ...
      const worker = new Worker(
        new URL("@/workers/merkle-wallet.worker.ts", import.meta.url),
        { type: "module" },
      );
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Upload a CSV file with wallet addresses to generate a Merkle tree
            and proofs for whitelisting.
          </p>
        </div>
        ...
        <div className="mt-12 p-6 bg-gray-800/30 border border-gray-700 rounded-xl">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-400">
              Each line should contain one wallet address. Empty lines are
              ignored.
            </p>
          </div>
        </div>
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="mt-4 text-sm text-gray-500">
          Supports CSV or text files with one address per line
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-gray-800/30 border border-gray-700 rounded-xl p-4 text-center">
          ...
          <div className="text-sm text-gray-400">File Upload</div>
        </div>
        <div className="bg-gray-800/30 border border-gray-700 rounded-xl p-4 text-center">
          <div className="text-2xl font-bold text-white mb-1">2</div>
          <div className="text-sm text-gray-400">Tree Generation</div>
        </div>
        <div className="bg-gray-800/30 border border-gray-700 rounded-xl p-4 text-center">
          <div className="text-2xl font-bold text-white mb-1">3</div>
          <div className="text-sm text-gray-400">Download Proofs</div>
        </div>
      </div>*/}
    </div>
  );
