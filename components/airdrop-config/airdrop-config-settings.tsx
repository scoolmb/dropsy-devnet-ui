...
import DropsyInput from "../input/dropsy-input";

interface AirdropConfigUpdateConfigProps {
  register: UseFormRegister<AirdropConfigUpdateFormValues>;
}

export function AirdropConfigSettings({
  register,
}: AirdropConfigUpdateConfigProps) {
  return (
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                {...register("protocolTreasury")}
                placeholder="The protocol Treasury address"
                type="text"
